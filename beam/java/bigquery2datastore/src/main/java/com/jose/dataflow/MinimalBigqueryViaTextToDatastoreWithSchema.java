...
public class MinimalBigqueryViaTextToDatastoreWithSchema {
    ...
    public interface Options extends PipelineOptions {
        ...
        @Description("Path of the BQ table to read from and store to Cloud Datastore")
        @Validation.Required
        String getInput();
...
//                    .put("CustomerIdentifier", makeValue(content.get("CustomerIdentifier").toString()).build());
    ...
    static class TextToJsonFn extends DoFn<String, HashMap> {
        @ProcessElement
        public void processElement(ProcessContext c) throws Exception {
            String s = c.element();
    ...
    static class JsonObjectToTableRowFn extends DoFn<HashMap, TableRow> {
        @ProcessElement
        public void processElement(ProcessContext c) throws Exception {
            HashMap m = c.element();
    ...
    public static void main(String[] args) throws Exception {
        ...
        p.apply("Reading Text Data", TextIO.read().from(options.getInputText()))
         .apply("Convert JSON text to HashMaps", ParDo.of(new TextToJsonFn()))
         .apply("Convert HashMap to TableRow", ParDo.of(new JsonObjectToTableRowFn()))
